...
<body>
    ...
    if(!empty($id)){
        $query_usuario = "SELECT id, nome_usuario, email_usuario, foto_usuario, created FROM 
        usuarios WHERE id=:id LIMIT 1";
        ...
        if((!empty($foto_usuario)) and (file_exists("imagens/$id/$foto_usuario"))){
            //echo "<img src='imagens/$id/$foto_usuario' width='35%'><br>";
            echo "<div class='imgbtn'>
            <img src='imagens/$id/$foto_usuario' width='35%'><br><br>
