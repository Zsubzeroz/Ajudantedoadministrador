...
<!--Menu fim-->
    ...
    <div class="btn-group">
        <a href="formulario.php" class=" btn btn-primary">Incluir</a>
        <a href="./Foto/index.php" class=" btn btn-info">Fotos</a>
    </div><br><br>
    <div class="m-5">
            ...
            <tbody>
                <?php
                    while($user_data = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>".$user_data['peça']."</td>";
                        echo "<td>".$user_data['quantidade']."</td>";
                        echo "<td>".$user_data['valorunit']."</td>";
